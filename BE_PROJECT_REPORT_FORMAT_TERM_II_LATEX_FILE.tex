...
\begin{center}
	\begin{figure}[!htbp]
		\centering
		\includegraphics[scale=0.55]{correct_dfdL21.png}
...
\end{equation}
\\\\The respective precision, recall and F1 scores of the classifiers used in our project are shown in the figures below (attached as screenshots).
\newpage
\subsection{Precision, recall and F1 score for Naive Bayes Classifier}
\begin{center}
	\begin{figure}[!htbp]
		\fbox{\includegraphics[width=350pt,height=180pt]{NB.png}}
		\caption{Screenshot of precision, recall and F1 of Naive Bayes}
...
\begin{center}
	\begin{figure}[!htbp]
		\fbox{\includegraphics[width=350pt,height=180pt]{LSTM.png}}
		\caption{Screenshot of precision, recall and F1 of LSTM}
